...
public class Pilha <X> implements Cloneable
{
    ...
    {        
		...
		ret = 13 * ret + new Integer (this.ultimo).hashCode();
		ret = 5  * ret + new Integer (this.tamanhoInicial).hashCode();

        for(int posicao = 0; posicao < ultimo; posicao++)	
        {	  
			ret = 7 * ret + this.elemento[posicao].hashCode();
		}
    ...
    public Pilha (Pilha<X> copia) throws Exception
    {
        // FAÇA
		...
		this.tamanhoInicial  = copia.tamanhoInicial;

		
      //this.elem = new X [this.modelo.length];
        this.elemento = (X[]) new Object [copia.elemento.length];
  
		for (int posicao = 0; posicao < this.ultimo; posicao++)
		    this.elemento[posicao] = copia.elemento[posicao];
    }
